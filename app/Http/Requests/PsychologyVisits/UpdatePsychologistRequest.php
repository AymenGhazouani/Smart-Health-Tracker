...
class UpdatePsychologistRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => 'sometimes|email|unique:psychologists,email,' . $psychologistId . '|max:255',
            'phone' => 'sometimes|nullable|string|max:20|regex:/^[\+]?[0-9\s\-\(\)]+$/',
            'specialty' => 'sometimes|string|max:255|min:2',
            ...
            'hourly_rate' => 'sometimes|nullable|numeric|min:0|max:999999.99|decimal:0,2',
    ...
    {
        return [
            'name.string' => 'Le nom du psychologue doit être une chaîne de caractères.',
