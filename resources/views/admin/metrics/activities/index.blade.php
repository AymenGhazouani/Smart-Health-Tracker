...
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
    <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
        ...
        <form method="POST" action="{{ route('admin.metrics.activities.notify', $user) }}">
            @csrf
            <input type="hidden" name="message" value="Please log a recent activity to keep your metrics up to date.">
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">No activities found.</p>
        </div>
    @endif
    </div>
