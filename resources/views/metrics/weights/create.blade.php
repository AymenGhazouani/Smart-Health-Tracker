...
@section('title', 'Add Weight Entry')
...
<div class="metrics-form-page">
    <header class="page-header">
        <div class="header-content">
            ...
            <p>Record a new weight measurement</p>
        </div>
        <div class="header-icon">⚖️</div>
    </header>

    <div class="form-container">
        <form method="POST" action="{{ route('metrics.weights.store') }}" class="metrics-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="note" 
                          ...
                          placeholder="Add any notes about this measurement (e.g., after workout, morning weight, etc.)">{{ old('note') }}</textarea>
                @error('note')
                    <p class="error-message">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="preview-card">
                ...
                <div class="preview-content">
                    <div class="preview-item">
                        ...
                        <span class="preview-value" id="preview-weight">-- kg</span>
                    </div>
                    <div class="preview-item">
